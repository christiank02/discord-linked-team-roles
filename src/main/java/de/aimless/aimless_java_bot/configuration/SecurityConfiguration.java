...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(@Value("${AIMLESS_BOT_OAUTH2_USER_AGENT}") String userAgent, @Value("${AIMLESS_BOT_GUILD_ID}") long guildId,
        ...
        http
                ...
                .oauth2Login(oauth2 ->
                        oauth2.tokenEndpoint(token ->
                                ...
                                .successHandler(new RestOAuth2SuccessHandler(guildId, jda, linkedRoleRepository, authorizedClientService))
                )
                .csrf(csrf ->
