...
public class RestOAuth2SuccessHandler implements AuthenticationSuccessHandler {
    ...
    public RestOAuth2SuccessHandler(@Value("${AIMLESS_BOT_NAME}") String botName, @Value("${AIMLESS_BOT_GUILD_ID}") long guildId, JDA jda, LinkedRoleRepository linkedRoleRepository, OAuth2AuthorizedClientService authorizedClientService) {
